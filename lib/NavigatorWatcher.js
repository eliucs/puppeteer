...
class NavigatorWatcher {
  ...
  _createTimeoutPromise() {
    ...
    const error = new Error('Navigation Timeout Exceeded: ' + this._timeout + 'ms exceeded');
    error.name = 'NavigationTimeoutExceededError';
  ...
  _cleanup() {
    ...
    error.name = 'NavigationFailedError';
    this._lifecycleCompleteCallback(error);

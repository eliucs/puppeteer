...
class NetworkManager extends EventEmitter {
  ...
  _handleRequestRedirect(request, redirectStatus, redirectHeaders, fromDiskCache, fromServiceWorker, securityDetails) {
    ...
    const error = new Error('Response body is unavailable for redirect responses');
    error.name = 'ResponseBodyUnavailableError';
    response._bodyLoadedPromiseFulfill.call(null, error);
